...
files=("check.sh" "check_cert.sh" "check_help.sh" "check_host.sh" "check_mail.sh" "check_rdns.sh" "check_ssl.sh" "check_norid" "check_update.sh" "hostguess.py" "rdns.py" "reverse-dns-lookup.py")
