...
def colorize_value(key, value):
    ...
    color_mappings = {
        ...
        "Phone Number": Fore.LIGHTGREEN_EX,
        "Mobile Phone Number": Fore.LIGHTGREEN_EX,
        "Email Address": Fore.LIGHTGREEN_EX,
        "Additional Email": Fore.LIGHTGREEN_EX
    }
...
def parse_norid_whois_output(whois_output):
    ...
    for line in whois_output.splitlines():
        ...
        if line and ':' in line and not line.startswith('%'):
            ...
            colored_key = f"{field_color_mappings.get(cleaned_key, Fore.WHITE)}{cleaned_key}{Fore.RESET}"
...
def main():
    ...
    if whois_output:
        ...
        headers = [f"{Fore.WHITE}Field{Fore.RESET}", f"{Fore.WHITE}Value{Fore.RESET}"]
